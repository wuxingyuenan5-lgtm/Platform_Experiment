...
For AI collaboration, assign exactly one implementation owner for code changes. Other agents should be used for bounded read-only investigation, review or acceptance unless the task explicitly grants separate implementation ownership.

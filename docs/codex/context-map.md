...
4. Three to eight directly affected source files and their direct tests.
5. `docs/architecture/OWNERSHIP.md` only when authority or dependency direction changes.
6. One task packet only for an active Critical cross-session task.

...
| Add or repair Research Provider | `research-provider` | `platform-api/AGENTS.md`, provider boundary, research service/cache/schema, smoke script and tests | frontend mapper only when the public contract changes | unrelated Providers, trading execution, full frontend |

...
- Active review: a stacked Draft PR based on `refactor/platform-0-9-3-repository-and-context-optimization`; it remains Open and Unmerged until explicit owner acceptance.
...
- Phase 2 Draft PR #141 remains Open, Draft and Unmerged; no Phase 3 code is added to it.
- Frontend package-manager authority: `pnpm@9.15.9`.
- `main` remains protected and is not modified directly.

GitHub owns the active branch, Draft PR, HEAD, CI and review state.

## Current phase

- Platform 0.9.3 Phase 3 — Codebase Reduction and Build Simplification is in progress from the exact accepted Phase 2 head.
- Current work is limited to proven non-product code/template removal, bounded route and View discovery, zero-consumer Workspace/dependency removal, build-input reduction and permanent regression gates.
- Formal product routes, menus, permissions, page state, UI behavior, API contracts, trading, risk, accounting, reconciliation and Live Write semantics must remain unchanged.
- Phase 2 documentation, repository and AI Context convergence is complete and remains the accepted base.

...
async function getAsyncMenus() {
  ...
  if (isBackMode()) {
    // console.log('isBackMode=====', permissionStore.getBackMenuList);
...
export async function getCurrentParentPath(currentPath: string, includeRedirect?: boolean) {
  const menus = await getAsyncMenus();
  const allParentPath = await getAllParentPath(menus, currentPath, includeRedirect);

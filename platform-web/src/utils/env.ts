...
export function getAppEnvConfig() {
  ...
  const {
    ...
    VITE_GLOB_API_URL_PLOY,
    VITE_GLOB_API_URL_MONITOR,
    // VITE_GLOB_API_URL_MONITOR2,
    // VITE_GLOB_API_URL_ACC,
    // VITE_GLOB_API_URL_FMONITOR,
    // VITE_GLOB_API_URL_MT5,
    VITE_GLOB_API_URL_FUTURE,
    VITE_GLOB_API_URL_DATA,
  } = ENV;

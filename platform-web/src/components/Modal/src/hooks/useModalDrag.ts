...
export function useModalDragMove(context: UseModalDragMoveContext, wrapBox?: any) {
  ...
  const handleDrag = () => {
    const dragWraps = document.querySelectorAll(wrapBox || '.ant-modal-wrap');
  ...
  watchEffect(() => {
    // console.log(1, !unref(context.open), !unref(context.draggable));

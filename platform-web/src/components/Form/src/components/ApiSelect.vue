...
<script lang="ts" setup>
  ...
  type OptionsResult = OptionsItem[] | BasicResult<OptionsItem>;
  ...
  const props = defineProps({
    ...
    api: {
      type: Function as PropType<(arg?: any) => Promise<OptionsResult>>,
      default: null,
    },
    // api params
    ...
    let data = unref(optionsRef).reduce((prev, next: any) => {
      if (next) {
        ...
        prev.push({
          ...
          label: typeof labelField == 'string' ? get(next, labelField) : labelField(next),

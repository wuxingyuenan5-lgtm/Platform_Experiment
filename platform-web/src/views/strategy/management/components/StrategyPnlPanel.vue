...
<script setup lang="ts">
  ...
  import { strategyPnlProfiles } from '../mock/pnl';
  ...
  const { setOptions: setBreakdownOptions, resize: resizeBreakdown } = useECharts(breakdownChartRef as Ref<HTMLDivElement>);
  ...
  async function renderBreakdownChart() {
    const palette = ['#3498db', '#55d6d9', '#f4bf45', '#ee746f', '#d05caa', '#7aa7ff', '#2fa86e', '#d8585f', '#8b6bd8'];

...
export const strategyPnlProfiles = {
  funding: {
    ...
    detailCurves: [
      { title: '资费收益', value: '+142,680', tone: 'positive', data: [12, 18, 31, 44, 58, 72, 88] },
      ...
      { title: '现货借贷成本', value: '-24,180', tone: 'negative', data: [-2, -5, -8, -11, -14, -18, -22] },
      { title: '持仓损益', value: '+82,360', tone: 'positive', data: [7, 14, 20, 27, 39, 58, 82] },
      { title: '累计交易成本', value: '-11,420', tone: 'negative', data: [-1, -3, -5, -7, -8, -10, -11] },
      { title: '执行偏差', value: '-4,280', tone: 'negative', data: [-0.6, -1.1, -1.4, -1.9, -2.4, -3.1, -4.3] },
    ],
  },
  crossSpread: {
    title: '跨所价差损益总览',
    ...
    attributions: [
      { label: '永续基差变动损益', value: '+31,860', ratio: '+14.9%', tone: 'positive' },
      { label: '代币基差变动损益', value: '-44,421', ratio: '-20.8%', tone: 'negative' },
      { label: 'U汇变动损益', value: '-20,128', ratio: '-9.4%', tone: 'negative' },
      { label: 'CFD价差变动损益', value: '-96,420', ratio: '-45.1%', tone: 'negative' },
      { label: '累计库存费', value: '+8,642', ratio: '+4.0%', tone: 'positive' },
      { label: '累计资金费', value: '-6,280', ratio: '-2.9%', tone: 'negative' },
      { label: '累计手续费', value: '-12,486', ratio: '-5.8%', tone: 'negative' },
      { label: '累计滑点成本', value: '-4,114', ratio: '-1.9%', tone: 'negative' },
    ],
    breakdownSeries: [
    ...
    detailCurves: [
      { title: '永续基差变动损益', value: '+31,860', tone: 'positive', data: [3, 5, 9, 14, 19, 24, 32] },
      { title: '代币基差变动损益', value: '-44,421', tone: 'negative', data: [-4, -12, -20, -26, -32, -39, -44] },
      { title: 'U汇变动损益', value: '-20,128', tone: 'negative', data: [-2, -6, -8, -12, -15, -17, -20] },
      { title: 'CFD价差变动损益', value: '-96,420', tone: 'negative', data: [-10, -18, -31, -44, -62, -79, -96] },
      { title: '累计库存费', value: '+8,642', tone: 'positive', data: [1, 2, 3, 4, 5, 7, 9] },
      { title: '累计资金费', value: '-6,280', tone: 'negative', data: [-0.8, -1.5, -2.3, -3.1, -4.0, -5.1, -6.3] },
      { title: '累计手续费', value: '-12,486', tone: 'negative', data: [-1.2, -2.5, -4.1, -5.8, -7.2, -9.6, -12.5] },
      { title: '累计滑点成本', value: '-4,114', tone: 'negative', data: [-0.4, -0.9, -1.3, -1.8, -2.2, -3.0, -4.1] },
    ],
  },
  domesticOverseas: {
    title: '海内外价差损益总览',
    ...
    detailCurves: [
      { title: '库存费累计收益', value: '+14,580', tone: 'positive', data: [2, 3, 5, 7, 9, 12, 15] },
      { title: '海内外溢价损益', value: '-44,421', tone: 'negative', data: [-5, -10, -14, -21, -28, -36, -44] },
      { title: '期现价差损益', value: '+31,860', tone: 'positive', data: [4, 8, 13, 18, 22, 27, 32] },
      { title: '汇率损益', value: '-378,224', tone: 'negative', data: [-32, -88, -142, -196, -251, -314, -378] },
      { title: '海外本金汇率损益', value: '-126,480', tone: 'negative', data: [-8, -24, -42, -61, -82, -104, -126] },
      { title: '库存费汇率损益', value: '-38,640', tone: 'negative', data: [-3, -8, -15, -21, -27, -32, -39] },
      { title: '国内汇率变动持仓损益', value: '-96,130', tone: 'negative', data: [-9, -23, -39, -56, -68, -81, -96] },
      { title: '海外持仓汇率损益', value: '-71,244', tone: 'negative', data: [-6, -18, -29, -41, -53, -62, -71] },
      { title: '国内对冲持仓汇率损益', value: '-45,730', tone: 'negative', data: [-4, -10, -18, -26, -33, -39, -46] },
    ],
  },
  dip: {
    title: '抄底策略损益总览',
    ...
    detailCurves: [
      { title: '已实现收益', value: '+76,580', tone: 'positive', data: [6, 12, 20, 29, 41, 58, 77] },
      { title: '浮动盈亏', value: '+41,820', tone: 'positive', data: [4, -2, 8, 16, 24, 32, 42] },
      { title: '止损损耗', value: '-8,114', tone: 'negative', data: [-1, -2, -2, -4, -5, -7, -8] },
      { title: '交易成本', value: '-4,520', tone: 'negative', data: [-0.5, -1, -1.6, -2.2, -3, -3.8, -4.5] },
    ],
  },
  shortLineTraderL: {
    title: '短线交易员L损益总览',
    ...
    detailCurves: [
      ...
      { title: '止损损耗', value: '-16,860', tone: 'negative', data: [-2, -4, -8, -10, -12, -14, -17] },
      ...
      { title: '手续费成本', value: '-4,880', tone: 'negative', data: [-0.6, -1.1, -1.9, -2.4, -3.1, -3.8, -4.9] },
    ],
  },
  spread: {
    title: '价差策略损益总览',
...
strategyPnlProfiles.shortLineTraderW.title = '短线交易员W损益总览';

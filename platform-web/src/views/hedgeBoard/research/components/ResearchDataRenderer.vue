...
<script setup lang="ts">
  ...
  const labels: Record<string, string> = {
    ...
    totalBalance: '两融合计',
    holderCount: '股东户数',
    averageFreeShares: '户均持股',
    history: '历史记录',
    mainNet20d: '近20日主力净流入',
    mainNet: '主力净流入',
    smallNet: '小单净流入',
    mediumNet: '中单净流入',
    largeNet: '大单净流入',
...
<style scoped lang="less">
  ...
  .data-object dt:last-of-type,
  .data-object dd:last-of-type {
    border-bottom: 0;
  }

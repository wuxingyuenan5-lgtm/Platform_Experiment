...
function makeResearch(
  ...
  return {
    ...
    note,
    executionMemo: `当前建议把 ${exchange} 的 ${symbol} 放在研究优先级较高的位置，继续跟踪 funding、净 carry、稳定性与容量。执行前继续跟踪 funding、净 carry、稳定性与容量。`,
    decision: {
      label: decisionLabel,
      tone: decisionTone,
    },
    ...
    insightBlocks: [
      ...
      },
      {
        ...
        description: note,
        meta: [`Stability ${stability}`, `Capacity ${capacity}`, '状态跟踪'],
      },
      {
        title: '容量判断',
        badge: `${capacity}`,

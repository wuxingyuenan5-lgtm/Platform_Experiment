...
const fundingTables: Record<string, StrategyTableSection> = {
  ...
  logs: {
    ...
    rows: [
      {
        time: '2026-06-25 10:31:08',
        type: '执行成功',
        content: 'BTC 资费套利双腿成交完成。',
        status: '处理完成',
      },
      {
        time: '2026-06-25 09:57:12',
        type: '执行提醒',
        content: 'ETH 合约腿部分成交，等待补齐。',
        status: '处理中',
      },
    ],
  },
...
function makeTwoLegTables(
  leftLabel: string,
  rightLabel: string,
): Record<string, StrategyTableSection> {
  return {
    positions: {
      columns: [
        { key: 'symbol', label: '标的' },
      ...
      rows: [
        {
          time: '2026-06-25 10:18:20',
          type: '双腿成交',
          content: `${leftLabel} 与 ${rightLabel} 执行完成。`,
          status: '处理完成',
        },
        {
          time: '2026-06-25 09:26:11',
          type: '人工确认',
          content: '价差偏离触发人工复核。',
          status: '处理完成',
        },
...
const shortLineTables: Record<string, StrategyTableSection> = {
  ...
  logs: {
    ...
    rows: [
      {
        time: '2026-06-25 13:12:33',
        type: '风控提醒',
        content: 'BTC 追单后波动放大，触发一次减仓提醒。',
        status: '处理完成',
      },
      {
        time: '2026-06-25 10:18:44',
        type: '人工复核',
        content: '黄金止盈单撤回，已发送人工复核消息。',
        status: '处理完成',
      },
    ],
  },
...
} as unknown as Record<StrategyDeskKey, StrategyOrderProfile>;
...
strategyOrderProfiles.shortLineTraderW = {
  ...
  tables: {
    positions: {
      columns: shortLineTables.positions.columns,
      rows: [
        {
          symbol: '低波动ETF',
          category: 'ETF',
    ...
    history: {
      columns: shortLineTables.history.columns,
      rows: [
        {
          time: '2026-06-25 10:36:18',
          symbol: '低波动ETF',
          side: '回补',
          price: '1.028',
          size: '42万份',
    ...
    fills: {
      columns: shortLineTables.fills.columns,
      rows: [
        {
          orderId: 'B-6182',
          symbol: '低波动ETF',
    ...
    logs: {
      columns: shortLineTables.logs.columns,
      rows: [
        {
          time: '2026-06-25 10:48:02',
          type: '回归确认',
          content: '低波动ETF偏离收敛，仓位维持。',
          status: '处理完成',
        },
        {
          time: '2026-06-25 09:58:41',
          type: '风险提醒',
          content: '红利篮子成交扩散不足，降低后续批次权重。',
          status: '处理完成',
        },
      ],
    },

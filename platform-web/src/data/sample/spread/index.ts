...
export const spreadChartDates = ['03-17', '03-18', '03-19', '03-20', '03-21', '03-22', '03-24', '03-26', '03-28', '03-30', '04-01', '04-03', '04-05', '04-07', '04-09', '04-11', '04-13', '04-15'];
export const spreadSeries = [18.2, 17.9, 16.8, 14.4, 12.2, 10.9, 8.1, 7.4, 8.6, 10.3, 12.5, 14.8, 16.7, 18.1, 19.4, 18.8, 18.1, 17.3];
export const goldPriceSeries = [2331, 2334, 2338, 2329, 2321, 2318, 2306, 2301, 2305, 2316, 2328, 2340, 2352, 2359, 2362, 2361, 2358, 2354];

  ...
  <div ref="wrapRef" :class="getWrapperClass">
    ...
    <div :class="bodyPadding">
      <Table
        ...
        :rowClassName="
          (record, index) => getRowClassName(record, index) + (canClickItem ? ' can-click ' : '')
        "
...
<script lang="ts" setup>
  ...
  const getBindValues = computed(() => {
    ...
    let propsData: any = {
      ...
      scroll: props.isScroll ? unref(getScrollRef) : undefined,
...
<!-- <style lang="less">
  ...
  .@{prefix-cls} {
    ...
    .ant-table-wrapper {
      ...
      // .ant-table-tbody > tr.ant-table-row:not(.can-click):hover > td {
    ...
    .ant-table {
      ...
      .ant-table-tbody > tr.vg-basic-table-row__striped > td {
        background-color: @app-content-background-striped;
      }

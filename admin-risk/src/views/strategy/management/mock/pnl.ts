...
export const strategyPnlProfiles = {
  ...
  crossSpread: {
    ...
    detailCurves: [
      { title: 'XAUT/XAU价差损益', value: '-44,421', tone: 'negative', data: [-4, -12, -20, -26, -32, -39, -44] },
      { title: '永续/现货价差损益', value: '+31,860', tone: 'positive', data: [3, 5, 9, 14, 19, 24, 32] },
      { title: 'USDT/USD偏离损益', value: '-20,128', tone: 'negative', data: [-2, -6, -8, -12, -15, -17, -20] },
      { title: '腿间持仓损益', value: '-96,420', tone: 'negative', data: [-10, -18, -31, -44, -62, -79, -96] },
      { title: '库存费', value: '+8,642', tone: 'positive', data: [1, 2, 3, 4, 5, 7, 9] },
      { title: '资费', value: '-6,280', tone: 'negative', data: [-0.8, -1.5, -2.3, -3.1, -4.0, -5.1, -6.3] },
      { title: '累计交易成本', value: '-12,486', tone: 'negative', data: [-1.2, -2.5, -4.1, -5.8, -7.2, -9.6, -12.5] },
      { title: '执行偏差', value: '-4,114', tone: 'negative', data: [-0.4, -0.9, -1.3, -1.8, -2.2, -3.0, -4.1] },
    ],
  },
  domesticOverseas: {
    title: '海内外价差损益总览',

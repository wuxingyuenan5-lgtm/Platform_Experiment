...
export const tradingToolCategories: TradingToolCategory[] = [
    ...
    "groups": [
      {
        "id": "macro-group-1",
        "title": "宏观总览",
        "description": "来自 Markdown 分组“宏观总览”。",
        "tools": [
          {
      ...
      },
      {
        "id": "macro-group-2",
        "title": "美联储、美国经济数据",
        "description": "来自 Markdown 分组“美联储、美国经济数据”。",
        "tools": [
          {
      ...
      },
      {
        "id": "macro-group-3",
        "title": "美债类",
        "description": "来自 Markdown 分组“美债类”。",
        "tools": [
          {
            "id": "macro-sc-macromicro-me-4",
            "name": "美国财政部每月债券发行量|MacroMicro",
  ...
  },
  {
    "id": "equity",
    "title": "股市工具",
    "description": "股票、ETF、财报、持仓与市场情绪研究工具。",
    "groups": [
      {
        "id": "equity-group-1",
        "title": "股市总览",
        "description": "来自 Markdown 分组“股市总览”。",
        "tools": [
          {
      ...
      },
      {
        "id": "equity-group-2",
        "title": "ETF总览",
        "description": "来自 Markdown 分组“ETF总览”。",
        "tools": [
          {
  ...
  },
  {
    "id": "crypto",
    "title": "加密工具",
    "description": "链上、衍生品、ETF 资金流与加密市场跟踪工具。",
    "groups": [
      {
        "id": "crypto-group-1",
        "title": "研报类",
        "description": "来自 Markdown 分组“研报类”。",
        "tools": [
          {
      ...
      },
      {
        "id": "crypto-group-2",
        "title": "交易类",
        "description": "来自 Markdown 分组“交易类”。",
        "tools": [
          {
            "id": "crypto-www-macromicro-me-1",
            "name": "BTC驱动三大因素：流动性＆实际利率＆PE",
      ...
      },
      {
        "id": "crypto-group-3",
        "title": "基本面类",
        "description": "来自 Markdown 分组“基本面类”。",
        "tools": [
          {
      ...
      },
      {
        "id": "crypto-group-4",
        "title": "媒体类",
        "description": "来自 Markdown 分组“媒体类”。",
        "tools": [
          {
      ...
      },
      {
        "id": "crypto-group-5",
        "title": "理财与其他",
        "description": "来自 Markdown 分组“理财与其他”。",
        "tools": [
          {
  ...
  },
  {
    "id": "metal",
    "title": "金属工具",
    "description": "黄金、白银、铜与贵金属产业链跟踪工具。",
    "groups": [
      {
        "id": "metal-group-1",
        "title": "黄金总览",
        "description": "来自 Markdown 分组“黄金总览”。",
        "tools": [
          {
      ...
      },
      {
        "id": "metal-group-2",
        "title": "商品总览",
        "description": "来自 Markdown 分组“商品总览”。",
        "tools": [
          {
  ...
  },
  {
    "id": "general",
    "title": "综合工具",
    "description": "跨品类通用研究、资讯、数据与辅助工具。",
    "groups": [
      {
        "id": "general-group-1",
        "title": "交易新闻和高手跟踪类总览",
        "description": "来自 Markdown 分组“交易新闻和高手跟踪类总览”。",
        "tools": [
          {
      ...
      },
      {
        "id": "general-group-2",
        "title": "其他总览",
        "description": "来自 Markdown 分组“其他总览”。",
        "tools": [
          {
      ...
      },
      {
        "id": "general-group-3",
        "title": "衍生品总览",
        "description": "来自 Markdown 分组“衍生品总览”。",
        "tools": [
          {
  ...
  },
  {
    "id": "quant",
    "title": "量化工具",
    "description": "量化研究、数据接口、策略开发与回测工具。",
    "groups": [
      {
        "id": "quant-group-1",
        "title": "量化总览",
        "description": "来自 Markdown 分组“量化总览”。",
        "tools": [
          {
      ...
      },
      {
        "id": "quant-group-2",
        "title": "量化类好文章",
        "description": "来自 Markdown 分组“量化类好文章”。",
        "tools": [
          {

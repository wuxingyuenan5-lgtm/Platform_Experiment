...
class FormalPnlResponse(BaseModel):
    ...
    total_spread_change_pnl: Decimal | None = Field(default=None, alias="totalSpreadChangePnl")
    perpetual_basis_pnl: Decimal | None = Field(default=None, alias="perpetualBasisPnl")
    token_basis_pnl: Decimal | None = Field(default=None, alias="tokenBasisPnl")
    u_fx_pnl: Decimal | None = Field(default=None, alias="uFxPnl")
    cfd_spread_pnl: Decimal | None = Field(default=None, alias="cfdSpreadPnl")
    cumulative_commission: Decimal | None = Field(default=None, alias="cumulativeCommission")
    cumulative_slippage_cost: Decimal | None = Field(default=None, alias="cumulativeSlippageCost")
    pnl_attribution_residual: Decimal | None = Field(default=None, alias="pnlAttributionResidual")

...
from app.live_venue_snapshot_sync import router as live_venue_snapshot_sync_router
...
def create_application() -> FastAPI:
    ...
    application.include_router(live_venue_snapshot_sync_router)

...
PACKS: dict[str, Pack] = {
    ...
    "research-field": Pack(
        ...
        (
            "platform-backend/app/research_providers.py",
            "platform-backend/app/research_cache.py",
            "platform-backend/tests/test_a_share_research_policy.py",
        ),
        (
    ...
    "member-contract": Pack(
        ...
        (
            ...
            "platform-backend/app/member_holding_service.py",
            "platform-backend/tests/test_member_holdings.py",
        ),
        (
            "platform-backend/app/member_holding_repository.py",
    ...
    "research-provider": Pack(
        ...
        (
            ...
            "platform-backend/app/research_cache.py",
            "platform-backend/app/research_data_schemas.py",
            "platform-backend/scripts/smoke_research_providers.py",
            "platform-backend/tests/test_research_service.py",
        ),
        (
            "admin-risk/src/api/hedgeResearch.ts",
        ...
        (
            "cd platform-backend && python -m pytest tests/test_research_service.py",
            "cd platform-backend && python scripts/smoke_research_providers.py --timeout 60",
        ),
    ),
    "user-e2e": Pack(
